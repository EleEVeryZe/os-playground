...
000000000040131b <string_length>: ; p = 'hello'
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi) ;
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx ;rdx = p
  401323:	48 83 c2 01          	add    $0x1,%rdx ;rdx = p[1];
  401327:	89 d0                	mov    %edx,%eax ;eax = p[1];
  401329:	29 f8                	sub    %edi,%eax ;exit
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx ; rbx: usrTyped
  40133f:	48 89 f5             	mov    %rsi,%rbp ; rbp: 0x402400
