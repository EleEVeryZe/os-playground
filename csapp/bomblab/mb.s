...
0000000000001141 <main>:
    ...
    114d:	c7 45 f8 10 00 00 00 	movl   $0x10,-0x8(%rbp)
    1154:	c7 45 fc 20 00 00 00 	movl   $0x20,-0x4(%rbp)
    115b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    1162:	eb 12                	jmp    1176 <main+0x35>
    1164:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1167:	8b 45 f8             	mov    -0x8(%rbp),%eax
    116a:	89 d6                	mov    %edx,%esi
    116c:	89 c7                	mov    %eax,%edi
    116e:	e8 b6 ff ff ff       	call   1129 <sum>
    1173:	01 45 f4             	add    %eax,-0xc(%rbp)
    1176:	83 7d f4 5f          	cmpl   $0x5f,-0xc(%rbp)
    117a:	7e e8                	jle    1164 <main+0x23>
